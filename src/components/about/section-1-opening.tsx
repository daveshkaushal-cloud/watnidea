...
/**
 * AboutOpening — Section 1
 * Full-screen cinematic introduction to "the mind of WatNidea".
 *
 * Mouse-reactive living digital ecosystem visual:
 *   - floating particles (canvas)
 *   - identity symbols (lucide glyphs drifting)
 *   - red energy streams (SVG animated paths)
 *   - liquid metallic structures (blurred gradient blobs morphing)
 *   - parallax depth (foreground moves more than background)
 *
...
import { MaskLine, RedGradientText } from './shared'
...
/* ===================================================================
   AboutOpening — Section 1 default export
   =================================================================== */
export default function AboutOpening() {
  ...
  return (
    <section
      ...
      aria-label="About WatNidea — Immersive Opening"
    >
      ...
      >
        ...
        >
          ...
          <span className="wn-eyebrow text-[11px] font-medium text-white/70 sm:text-xs">
            Creative
            <span className="mx-2 text-[#E53935]">•</span>
            Performance
            <span className="mx-2 text-[#E53935]">•</span>
            AI
          </span>
