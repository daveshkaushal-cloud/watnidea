...
/**
 * AboutHowWeThink — Section 5
 * Horizontal storytelling — pinned/sticky horizontal scroller with 5 stages.
 *
 ...
 *   01 Identity · 02 Experience · 03 Attention · 04 Growth · 05 Community
 *
...
function ExperienceVisual() {
  return (
    <div className="relative h-full w-full" aria-hidden>
      ...
      {/* browser frame */}
      <motion.div
        className="absolute left-1/2 top-1/2 w-[78%] max-w-[340px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-xl border border-white/15 bg-white/[0.06] backdrop-blur-md"
        animate={{ y: [0, -8, 0] }}
      ...
      >
        ...
        <div className="space-y-2 p-3">
          ...
          <div className="mt-3 grid grid-cols-3 gap-1.5">
            <div className="h-8 rounded-sm bg-white/[0.08]" />
            <div className="h-8 rounded-sm bg-white/[0.08]" />
...
function CommunityVisual() {
  // 6 outer nodes connected to center hub.
  // Round positions to 3 decimals to avoid SSR/hydration float mismatches.
...
/* ===================================================================
   AboutHowWeThink — Section 5 default export.
